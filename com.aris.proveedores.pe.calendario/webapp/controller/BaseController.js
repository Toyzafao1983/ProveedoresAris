sap.ui.define([
	...
	'sap/m/Token',
	"com/aris/proveedores/pe/calendario/services/ServiceOdata",
	...
	var sMessage = "";
	var that;
	return Controller.extend("com.aris.proveedores.pe.calendario.controller.BaseController", {
		formatter: Formatter,
		local: window.location.href.indexOf('launchpad') == -1 ? true : false,
		localModel: true,
		AdminUser: true,
		userSet: "kestefo@ravaconsulting.com.pe",
		route: "com.aris.proveedores.pe.calendario",
		_getUsers: function () {
			that = this;
			try {
		...
		createColumnConfig: function () {
			return [
				...
				{
					label: this.getI18nText("titlecalendario"),
					property: 'txt2',
					width: '20',
					type: 'String'
				},
		...
		createColumnConfigDetalle: function () {
			return [
				...
				{
					label: this.getI18nText("TextDetailSupplier"),
					property: 'txt2',
					width: '20',
					type: 'String'
				},
				{
					label: this.getI18nText("TextDetailNumPedComp"),
					property: 'txt3',
					width: '15'
				},
				{
			...
			try {
				...
				return new Promise(function (resolve, reject) {
					let sUrl = "",
						sNumPedido = "";
					if (that.local) {
						const sPath = "/sap/opu/odata/sap/ZSD_PORTAL_PROVEEDORES_SRV/INPUT_CONSULTAS_ORDCOMPRASSET?$expand=ToConsultasOrdCompras&$filter=PROVEEDOR eq '2000000002' and TIPO eq '' and EJERCICIO_DESDE eq '2025011' and EJERCICIO_HASTA eq '20251118'";
						sUrl = that.getOwnerComponent().getManifestObject().resolveUri(sPath);
					} else {
						const sPath = jQuery.sap.getModulePath(that.route) + "/S4HANA/sap/opu/odata/sap/ZSD_PORTAL_PROVEEDORES_SRV/INPUT_CONSULTAS_ORDCOMPRASSET?$expand=ToConsultasOrdCompras&$filter=PROVEEDOR eq '2000000002' and TIPO eq '' and EJERCICIO_DESDE eq '2025011' and EJERCICIO_HASTA eq '20251118'";
						sUrl = sPath;
					}
