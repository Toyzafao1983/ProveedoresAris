sap.ui.define([
	...
	return {
		...
		formatMonth: function (iMesNum, sLang) {
			if (!iMesNum) return "";
			// obtenemos el i18n activo
			var oI18n = sap.ui.getCore().getModel("i18n");
			if (oI18n && oI18n.getResourceBundle) {
				return oI18n.getResourceBundle().getText("month." + iMesNum);
			}
			return iMesNum.toString();
		}
